...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None):
        ...
        # The model stride is not always known at validator construction time. Training has already aligned imgsz
        # with trainer.model.stride, while standalone validation checks again after AutoBackend exposes model.stride.
        self.args.imgsz = check_imgsz(self.args.imgsz, stride=1, max_dim=1)
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            self.args.quantize = 16 if (self.device.type != "cpu" and trainer.amp and self.args.val_half) else None

...
| LocateAnything-3B NPU 推理优化 | 2026-08-17、2026-08-18 | 8卡 batch=8 提升 29.24%，batch=128 安全优化提升 6.38%，退化长尾批缩短 29.92% | [LocateAnything 报告](./locateanything/locateanything_3b_910b2_report.md) | [JSON](./locateanything/locateanything_3b_910b2_results.json) |
...
- `locateanything/`：LocateAnything-3B 的固定revision NPU算子探针、8卡batch=8/128基准和撤回实验记录。
